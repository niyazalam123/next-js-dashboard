...
const page = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if(resp.ok){
        toast.success("Update successfully",{position: "top-center",theme: "colored"});
      }
    } catch (error) {
        toast.warn("internal server error", { position: "top-center", theme: "colored" });
    }
    finally{
        setLoader(false);
    }
  ...
  return (
    <>
      ...
      <div className="_task_ass1">
        ...
        <button onClick={handleUpdate}>{loader?"Loading...":"update"}</button>
      </div>
